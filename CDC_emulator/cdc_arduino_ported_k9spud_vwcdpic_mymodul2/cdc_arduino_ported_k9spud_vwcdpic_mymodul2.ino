...
//for 8k of ATmega88 we cannot use BK8000L library!!! it will not fit!
// or will it? with LTO :)
//#define DUMPMODE
//#define DUMPMODE2
...
static void DecodeCommand(void)
{
  ...
  switch (cmdcode) {
    ...
    case Do_CD5:
      ...
      {
        EnqueueString(sBK8000L_DISCONNECT);//"AT+CD\r\n";
        EnqueueString(sBK8000L_PAIRING_INIT);//"AT+CA\r\n"; //  pairing   AT+CA\r\n
        EnqueueString(sBK8000L_PAIRING_EXIT);//"AT+CB\r\n"; //  Exit pairing  AT+CB\r\n
      }
      break;
    ...
    case Do_CD6:
      ...
      {
        EnqueueString(sBK8000L_DISCONNECT);//"AT+CD\r\n";
        EnqueueString(sBK8000L_CONNECT_LAST_DEVICE);//"AT+CC\r\n"; //  The last paired device connected  AT+CC\r\n     what this should do? connect to last connected device?
      }
