...
#define RADIO_COMMAND 8
#define RADIO_CLOCK 13
#define RADIO_DATA 11
...
/*!
  ...
  tomaskovacik:
   measured on scope on 16Mhz atmega328 (a.NANO): _delay_loop_1(40) = 61kHz, delayMicroseconds(8) give as 67kHz
   shiftOut(11,13,MSBFIRST,byte_u8) give as error on audi concert 1: CD1 ERR3, on scop freq was almost 80kHz
*/
//-----------------------------------------------------------------------------
...
ISR(TIMER1_CAPT_vect)
{
  ...
  if (!digitalRead(RADIO_COMMAND))//(PINB & _BV(RADIO_COMMAND)) == 0)
  {
