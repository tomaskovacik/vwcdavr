...
EnqueueHex(Do_CHANGECD);
    break;



  case Do_ENABLE:
EnqueueHex(Do_ENABLE);
    break;
  case Do_ENABLE_MK:
...
EnqueueHex(Do_DISABLE);
    break;



  case Do_SEEKBACK:
EnqueueHex(Do_SEEKBACK);

    break;
  case Do_PREVCD:


//for shyd mpd control
                            if ((disc & 0x0F)== 1)
                              EnqueueHex(Do_CD6);
                            if ((disc & 0x0F) == 2)
                              EnqueueHex(Do_CD1);
