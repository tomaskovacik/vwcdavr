...
const uint8_t sCD[] PROGMEM = "CD: ";
const uint8_t sTR[] PROGMEM = " TRACK: ";
const uint8_t sMIN[] PROGMEM = " MIN: ";
...
//
////arduinoSPI used:
//SPI.transfer(display_byte_buffer_mau8[display_byte_counter_u8]);
///*
